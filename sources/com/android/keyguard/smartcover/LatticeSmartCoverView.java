...
public class LatticeSmartCoverView extends SmartCoverView {
    ...
    public LatticeSmartCoverView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onFinishInflate() {
        ...
        Typeface typeface = Typeface.create("miuiex-bitmap", 0);
        this.mInfo1TextView.setTypeface(typeface);
        this.mInfo2TextView1.setTypeface(typeface);
        this.mInfo2TextView2.setTypeface(typeface);
        this.mBatteryLevelText.setTypeface(typeface);
    }
    ...
    public void refresh() {
        ...
        int i3 = R.drawable.smart_cover_miss_call;
        if (z && this.mShowSms) {
            ...
            if (!this.mShowMissCall) {
                i3 = R.drawable.smart_cover_sms;
            }
            imageView.setImageResource(i3);
        } else if (this.mCharging || this.mLevel <= this.mLowBatteryWarningLevel) {
            BatteryLevelImageView batteryLevelImageView = this.mBatteryLevelImage;
            if (this.mCharging) {
                i = R.drawable.smart_cover_battery_charging;
            } else {
                i = R.drawable.smart_cover_battery_low;
            }
            batteryLevelImageView.setImageResource(i);
            ...
            if (this.mCharging) {
                i2 = this.mContext.getResources().getColor(R.color.smart_cover_battery_text_color);
            } else {
                i2 = this.mContext.getResources().getColor(R.color.smart_cover_battery_low_text_color);
            }
