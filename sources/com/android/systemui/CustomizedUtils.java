...
public class CustomizedUtils {
    private static boolean isCustomized = (Build.IS_CT_CUSTOMIZATION_TEST || Build.IS_CU_CUSTOMIZATION_TEST);
    ...
    public static int getNotchExpandedHeaderViewHeight(Context context, int defaultValue) {
