...
public class Interpolators {
    ...
    public static final Interpolator BACK_EASE_OUT = new BackEaseOutInterpolator();
    public static final Interpolator BACK_EASE_OUT_5 = new BackEaseOutInterpolator(5.0f);
    ...
    public static final Interpolator EASE_OUT = new SineEaseOutInterpolator();
    ...
    public static final Interpolator QUAD_EASE_OUT = new QuadraticEaseOutInterpolator();
