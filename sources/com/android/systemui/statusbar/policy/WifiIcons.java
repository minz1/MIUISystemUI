...
public class WifiIcons {
    ...
    public static final int[] WIFI_SIGNAL_STRENGTH_DARK = {R.drawable.stat_sys_wifi_signal_0_darkmode, R.drawable.stat_sys_wifi_signal_1_darkmode, R.drawable.stat_sys_wifi_signal_2_darkmode, R.drawable.stat_sys_wifi_signal_3_darkmode, R.drawable.stat_sys_wifi_signal_4_darkmode};
}
