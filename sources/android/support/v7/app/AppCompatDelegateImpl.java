...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext2, null, android.support.v7.appcompat.R.attr.actionModePopupWindowStyle);
            ...
            if (this.mActionModeView != null) {
                ...
                android.support.v7.view.ActionMode mode2 = new StandaloneActionMode(context, actionBarContextView, callback, z);
    ...
    public View createView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String viewInflaterClassName = this.mContext.obtainStyledAttributes(android.support.v7.appcompat.R.styleable.AppCompatTheme).getString(android.support.v7.appcompat.R.styleable.AppCompatTheme_viewInflaterClass);
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (st2.menu != null && !st2.refreshMenuContent && cb.onPreparePanel(0, st2.createdPanelView, st2.menu)) {
                cb.onMenuOpened(R.styleable.AppCompatTheme_tooltipForegroundColor, st2.menu);
