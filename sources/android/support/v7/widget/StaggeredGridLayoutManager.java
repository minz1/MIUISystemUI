...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    class Span {
        ...
        public void calculateCachedStart() {
            ...
            if (lp.mFullSpan) {
                LazySpanLookup.FullSpanItem fsi = StaggeredGridLayoutManager.this.mLazySpanLookup.getFullSpanItem(lp.getViewLayoutPosition());
        ...
        public void popEnd() {
            int size;
            View end = this.mViews.remove(this.mViews.size() - 1);
