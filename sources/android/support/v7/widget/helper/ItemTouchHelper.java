...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    private final RecyclerView.OnItemTouchListener mOnItemTouchListener = new RecyclerView.OnItemTouchListener() {
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == 0) {
                int unused = ItemTouchHelper.this.mActivePointerId = event.getPointerId(0);
                float unused2 = ItemTouchHelper.this.mInitialTouchX = event.getX();
                float unused3 = ItemTouchHelper.this.mInitialTouchY = event.getY();
                ItemTouchHelper.this.obtainVelocityTracker();
                if (ItemTouchHelper.this.mSelected == null) {
                    RecoverAnimation animation = ItemTouchHelper.this.findAnimation(event);
                    if (animation != null) {
                        float unused4 = ItemTouchHelper.this.mInitialTouchX = ItemTouchHelper.this.mInitialTouchX - animation.mX;
                        float unused5 = ItemTouchHelper.this.mInitialTouchY = ItemTouchHelper.this.mInitialTouchY - animation.mY;
            ...
            if (ItemTouchHelper.this.mActivePointerId != -1) {
                ...
                if (viewHolder != null) {
                    ...
                    if (action != 6) {
                        ...
                        ItemTouchHelper.this.select(null, 0);
                        int unused = ItemTouchHelper.this.mActivePointerId = -1;
                    } else {
                        ...
                        if (event.getPointerId(pointerIndex) == ItemTouchHelper.this.mActivePointerId) {
                            ...
                            int unused2 = ItemTouchHelper.this.mActivePointerId = event.getPointerId(newPointerIndex);
            ...
            if (this.mShouldReactToLongPress) {
                ...
                if (child != null) {
                    ...
                    if (vh != null && ItemTouchHelper.this.mCallback.hasDragFlag(ItemTouchHelper.this.mRecyclerView, vh) && e.getPointerId(0) == ItemTouchHelper.this.mActivePointerId) {
                        ...
                        float unused3 = ItemTouchHelper.this.mDx = ItemTouchHelper.this.mDy = 0.0f;
    ...
    public void select(android.support.v7.widget.RecyclerView.ViewHolder r29, int r30) {
        /*
            r28 = this;
            r11 = r28
            r12 = r29
